...
function EditBook() {
  ...
  const [form, setForm] = useState({
    ...
    categories: [],
    publishDate: '',
    translations: [{ language: '', title: '', description: '', summary: '', file: null, pdfUrl: null }],
    coverImage: '',
  });
  ...
  const addTranslation = () => {
    if (form.translations.length < 10) {
      setForm({ ...form, translations: [...form.translations, { language: '', title: '', description: '', summary: '', file: null, pdfUrl: null }] });
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Kapak resmi ekle (sadece yeni yüklendiyse)
      if (file) {
        formData.append('coverImage', file);
      }

      // Translations (çeviriler) güncelle - Her dil için title, description, summary ve PDF
      form.translations.forEach((translation, index) => {
        ...
        // Sadece yeni PDF yüklendiyse ekle
        if (translation.file) {
              ...
              <div key={idx} className="mb-4 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-5 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 hover:border-blue-300 dark:hover:border-blue-700 transition-all">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {translation.pdfUrl && !translation.file && (
