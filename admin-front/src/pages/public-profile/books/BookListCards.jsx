...
const getBookImage = (book) => {
  ...
  return '/media/images/book-placeholder.jpg';
};
          ...
          {coverUrl && (
            <div className="flex-shrink-0">
              <img
                ...
                onError={(e) => {
                  e.target.src = '/media/images/book-placeholder.jpg';
                }}
              />
            </div>
          )}
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="space-y-3">
              ...
              {book.translations && book.translations.length > 0 && (
                <div>
                  <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Çeviriler:</span>
                        ...
                        <div className="flex items-start justify-between gap-2">
                          ...
                          {(trans.pdfUrl || trans.pdfFile) && (
                            <a
                              ...
                              className="flex-shrink-0 px-3 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700 transition"
                            >
                              PDF
                            </a>
                          )}
                ...
                <div className="flex-1 min-w-0 w-full">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-400">
                      🌍 {book.translations?.length || 0} Dil
                    </span>
