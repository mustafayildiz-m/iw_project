...
export const MENU_SIDEBAR = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        status: 'pending',
        children: [
          { title: 'Etkinlik Ekle', path: '/etkinlikler/ekle',status: 'pending', },
          { title: 'Onay Bekleyen Etkinlikler', path: '/etkinlikler/onay-bekleyenler' ,status: 'pending',},
          { title: 'Yapay Zeka Ders Kayıtları', path: '/etkinlikler/ai-ders-kayitlari',status: 'pending', },
          { title: 'Aktif Etkinlik Takvimi', path: '/etkinlikler/takvim',status: 'pending', },
        ],
      },
      {
        title: 'Depolar',
  ...
  },
  {
    ...
    status: 'pending',
    children: [
      { title: 'Canlı Ders Konuları', path: '/ai/canli-ders-konulari' },
      { title: 'Cevap Havuzu Yönetimi', path: '/ai/cevap-havuzu' },
      { title: 'Etkinlik Modülü', path: '/ai/etkinlik-modulu' },
    ],
  },
  {
    title: 'Gönülden Notlar',
    icon: NoteIcon,
    status: 'pending',
    children: [
      { title: 'Paylaşılan Notlar', path: '/notlar/paylasilan' },
      { title: 'Gönülden Gelenler', path: '/notlar/gonulden-gelenler' },
      { title: 'Kullanıcılardan Mesajlar', path: '/notlar/kullanici-mesajlari' },
    ],
  },
  {
    ...
    status: 'pending',
    children: [
      { title: 'Tema Ayarları', path: '/ayarlar/tema' },
      { title: 'Çoklu Dil Ayarları', path: '/ayarlar/dil' },
      { title: 'Hesap Yönetimi', path: '/ayarlar/hesap' },
      { title: 'İstatistik Raporlama', path: '/ayarlar/istatistik' },
    ],
  },
  {
    ...
    status: 'pending',
    children: [
      { title: 'Sistem Bildirimleri', path: '/bildirimler/sistem' },
      { title: 'Kullanıcıya Bildirim Gönder', path: '/bildirimler/gonder' },
    ],
  },
];
