...
const ConversationList = () => {
  ...
  const getDisplayAvatar = useCallback((conversation) => {
    if (!conversation?.participantAvatar) return placeholderImg;
    
    const avatar = conversation.participantAvatar;
    if (typeof avatar !== 'string') return placeholderImg;
        ...
        {sortedConversations.length === 0 ? (
          ...
          sortedConversations.map((conversation) => {
            ...
            return (
              <div
                key={conversation.id}
                className={`conversation-item p-3 border-bottom position-relative ${
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  >
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <p className={`mb-0 small text-truncate me-2 ${
