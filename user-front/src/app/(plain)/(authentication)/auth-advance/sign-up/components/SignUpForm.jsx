...
const SignUpForm = () => {
  ...
  return <form className="mt-2" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="mb-2 text-start">
        <DropzoneFormInput
          label=""
          text={t('auth.profilePhotoOptional')}
          showPreview={true}
      ...
      <div className="d-grid mt-2">
        <Button 
          ...
          style={{
            ...
            padding: '1rem 1.5rem',
            borderRadius: '12px',
            boxShadow: loading || !isValid || !formValues.acceptTerms 
              ? 'none' 
              : '0 4px 15px rgba(102, 126, 234, 0.4)',
            transition: 'all 0.3s ease',
            fontSize: '1.05rem',
            minHeight: '54px',
            cursor: loading || !isValid || !formValues.acceptTerms ? 'not-allowed' : 'pointer',
            opacity: loading || !isValid || !formValues.acceptTerms ? 0.6 : 1
          }}
        >
          {loading ? (
            <>
