...
// User profile için menü öğeleri - Kitaplar bölümü olmadan
const getUserProfileMenuItems = (t) => [
  {
    key: 'profile-feed',
    label: t('profileMenu.feed'),
    url: '/profile/user/feed'
  },
  {
    key: 'profile-about',
    label: t('sidebar.about'),
    url: '/profile/user/about'
  }
];
...
const ProfileLayout = ({
  ...
  const getScholarImageUrl = (photoUrl) => {
  ...
  const getMenuItems = () => {
    if (profileType === 'user') {
      return getUserProfileMenuItems(t);
    }
      ...
      <Container>
        <Row className="g-4">
          <Col lg={8} className="vstack gap-4">
            <Card className="shadow-sm" style={{ borderRadius: '20px', overflow: 'hidden' }}>
              ...
              <CardBody className="py-0">
                  ...
                  <div>
                    <div className="position-relative d-inline-block">
                      ...
                      >
                        ...
                        />
                        {isOwnProfile() && (
                          <div className="position-absolute bottom-0 end-0 bg-success rounded-circle p-2 border border-white">
                  ...
                  <div className="d-flex mt-3 justify-content-center ms-sm-auto">
                    ...
                    <Dropdown>
                      ...
                      <DropdownMenu className="dropdown-menu-end" aria-labelledby="profileAction2">
                        <li>
                          <DropdownItem as="button" onClick={handleShareProfile}>
                            {' '}
                        ...
                        <li>
                          <DropdownItem as="button" onClick={handleShareOnWhatsApp}>
                            {' '}
                            <BsWhatsapp size={22} className="fa-fw pe-2 text-success" />
                        ...
                        <li>
                          <DropdownItem as="button" onClick={handleShareToFeed}>
                            {' '}
                            <BsNewspaper size={22} className="fa-fw pe-2 text-primary" />
                ...
                <ul className="list-inline mb-0 text-center text-sm-start mt-3 mt-sm-0">
                  <li className="list-inline-item">
                    <BsBriefcase className="me-1" /> {profileType === 'scholar' ? t('profileStatus.scholar') : t('profileStatus.user')}
                  </li>
                  <li className="list-inline-item">
                    <BsGeoAlt className="me-1" /> {getProfileLocation()}
                  </li>
                  <li className="list-inline-item">
                    <BsCalendarDate className="me-1" /> {formatDateTime(profileData?.createdAt || profileData?.created_at || profileData?.joinDate)}
                  </li>
                </ul>

                {/* Takipçi ve Takip Edilen Sayıları */}
                <div className="hstack gap-4 justify-content-center mt-3">
                  <div className="text-center">
                    <Link href={(() => {
                      ...
                      <h6 className="mb-0">{followStats.followersCount}</h6>
                      <small className="text-muted">{t('profileHeader.followers')}</small>
                    </Link>
                  </div>
                  {profileType !== 'scholar' && (
                    <>
                      ...
                      <div className="text-center">
                        <Link href={(() => {
                          ...
                          <h6 className="mb-0">{followStats.followingCount}</h6>
                          <small className="text-muted">{t('profileHeader.following')}</small>
                        </Link>
                      </div>
                    </>
                  )}
                    ...
                    return (
                      <li className="nav-item" key={idx}>
                        <Link className={clsx('nav-link', {
                          active: pathName === dynamicUrl
                        })} href={dynamicUrl}>
                          {item.label}
                          {item.key === 'profile-connections' && bookCount > 0 && (
                            <span className="badge bg-success bg-opacity-10 text-success small"> {bookCount}</span>
                          )}
                          {item.badge && item.key !== 'profile-connections' && (
                            <span className="badge bg-success bg-opacity-10 text-success small"> {item.badge.text}</span>
                          )}
                        </Link>
                      </li>
                    );
                ...
                <ModalBody className="pt-2">
                  <div className="text-center mb-4">
                    <div className="avatar avatar-xxl mx-auto mb-3">
                      <img
                        className="avatar-img rounded-circle border border-3 border-light shadow"
                ...
                <Card>
                  ...
                  <CardBody className="position-relative pt-0">
                    {friendsLoading ? (
                      ...
                      <>
                        <Row className="g-3">
                          {displayedScholars.map((scholar, idx) => (
                            <Col xs={6} key={scholar.id}>
                                  ...
                                  <div className="avatar avatar-xl">
                                    <span role="button">
                                      <Image
                                        ...
                                        src={getScholarImageUrl(scholar.photoUrl)}
