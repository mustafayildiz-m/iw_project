import { Controller, Get, Post, Body, Patch, Param, Delete, ParseIntPipe, Query, Request, UseGuards, UseInterceptors, UploadedFile, UnauthorizedException, BadRequestException } from '@nestjs/common';
...
export class UsersController {
  ...
  @Get('public/:id')
  async findOnePublic(@Param('id', ParseIntPipe) id: number): Promise<User | null> {
    return this.usersService.findOne(id);
  }

  @UseGuards(AuthGuard('jwt'))
  @Get(':id')
  async findOne(@Param('id', ParseIntPipe) id: number, @Request() req: any): Promise<User | (User & { isFollowing: boolean }) | null> {
