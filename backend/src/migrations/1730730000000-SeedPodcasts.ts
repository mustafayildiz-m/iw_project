...
export class SeedPodcasts1730730000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    for (let i = 0; i < 20; i++) {
      podcasts.push({
        ...
        duration: Math.floor(Math.random() * 3000) + 600, // 10-60 dakika arası
        author: authors[i % authors.length],
        language: 'tr',
        isActive: i % 10 !== 0, // Her 10'da bir pasif
        isFeatured: i % 7 === 0, // Her 7'de bir öne çıkan
