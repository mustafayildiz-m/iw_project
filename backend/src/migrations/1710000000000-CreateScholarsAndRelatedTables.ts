...
export class CreateScholarsAndRelatedTables1710000000000 implements MigrationInterface {
    name = 'CreateScholarsAndRelatedTables1710000000000'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Scholar Related Books tablosu (many-to-many ilişki tablosu)
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // Foreign key constraints'leri kaldır
