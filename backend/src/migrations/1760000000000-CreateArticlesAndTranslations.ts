...
export class CreateArticlesAndTranslations1760000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    const articlesForeignKeys = articleTranslationsTable?.foreignKeys.filter(
      (fk) => fk.columnNames.indexOf('articleId') !== -1 || fk.columnNames.indexOf('languageId') !== -1,
    );
