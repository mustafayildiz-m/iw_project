...
@Module({
  imports: [
    TypeOrmModule.forFeature([Scholar, ScholarBook, ScholarPost, ScholarPostTranslation, Source, Book, BookTranslation, Language]),
    UploadModule,
    UserScholarFollowModule,
  ],
  controllers: [ScholarsController, ScholarPostsController],
  providers: [ScholarsService, ScholarPostsService],
