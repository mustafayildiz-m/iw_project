import { Controller, Post, Delete, Get, Body, Query, Request, UseGuards } from '@nestjs/common';
...
export class UserScholarFollowController {
  constructor(private readonly userScholarFollowService: UserScholarFollowService) {}
