...
// DTO Definitions
class UploadPDFDto {
  @ApiProperty({ description: 'Enable alternative name support (parantez içi isimler)', default: true })
  @IsOptional()
  @IsBoolean()
  @Transform(({ value }) => {
  ...
  @ApiProperty({ description: 'Confidence threshold (40-100)', default: 40, minimum: 40, maximum: 100 })
  @IsOptional()
  @IsNumber()
  @Min(40)
  @Max(100)
  ...
  @ApiProperty({ description: 'Minimum name length', default: 3, minimum: 1, maximum: 50 })
  @IsOptional()
  @IsNumber()
  @Min(1)
  @Max(50)
  ...
  @ApiProperty({ description: 'Maximum name length', default: 120, minimum: 10, maximum: 200 })
  @IsOptional()
  @IsNumber()
  @Min(10)
  @Max(200)
  ...
  @ApiProperty({ description: 'Minimum word count', default: 2, minimum: 1, maximum: 5 })
  @IsOptional()
  @IsNumber()
  @Min(1)
  @Max(5)
  ...
  @ApiProperty({ description: 'Maximum word count', default: 10, minimum: 5, maximum: 20 })
  @IsOptional()
  @IsNumber()
  @Min(5)
  @Max(20)
...
class ParseDirectDto {
  @ApiProperty({ description: 'Path to PDF file', example: '/path/to/file.pdf' })
  @IsString()
  filePath: string;
...
export class PDFController {
  ...
  async uploadAndParse(
    ...
    try {
      ...
      throw new InternalServerErrorException(`Failed to start PDF processing: ${error.message}`);
    }
  }
