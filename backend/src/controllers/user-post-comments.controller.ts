...
export class UserPostCommentsController {
  constructor(private readonly userPostCommentsService: UserPostCommentsService) {}

  @Post()
  create(@Body() createUserPostCommentDto: CreateUserPostCommentDto, @Request() req: any) {
