import { Controller, Get, Post, Put, Delete, Body, Param, Query, ParseIntPipe, UseGuards, NotFoundException, Res } from '@nestjs/common';
...
export class IslamicNewsController {
  ...
  async findAll(
    ...
    const [news, totalCount] = await this.islamicNewsService.getNewsFromDatabase(
      limitNumber,
      offsetNumber,
      language,
      country,
