import { Controller, Post, Delete, Get, Body, Param, Request, UseGuards, ParseIntPipe, Query } from '@nestjs/common';
...
export class UserPostShareController {
  ...
  // Gönderi paylaş
  @Post()
  async sharePost(@Body() body: { post_id: string, post_type?: number | string }, @Request() req: any) {
