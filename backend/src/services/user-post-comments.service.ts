...
export class UserPostCommentsService {
  ...
  async create(createUserPostCommentDto: CreateUserPostCommentDto, userId: number) {
    const commentData = {
  ...
  async update(id: number, updateUserPostCommentDto: UpdateUserPostCommentDto, userId: number) {
