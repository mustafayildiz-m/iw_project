...
export class PDFSpecificScholarParser {
  ...
  private extractAlternativeName(fullName: string): { mainName: string; altName?: string } {
  ...
  private extractLineage(biography: string, scholarName: string): string | undefined {
