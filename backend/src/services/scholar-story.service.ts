...
export class ScholarStoryService {
  ...
  async create(createScholarStoryDto: CreateScholarStoryDto): Promise<ScholarStory> {
    try {
  ...
  async update(id: number, updateScholarStoryDto: UpdateScholarStoryDto): Promise<ScholarStory> {
    try {
