...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      synchronize: false,
        ...
        TypeOrmModule.forFeature([Scholar, Book, ScholarPost, Language, IslamicNews, ScholarStory, StoryView, StoryLike, BookTranslation, BookCategory, Article, ArticleTranslation, User]),
    BooksModule,
    ArticlesModule,
    UploadModule,
    AuthModule,
  ...
  providers: [CronService, LanguagesSeeder, RegionalBooksSeeder, ReligiousBooksSeeder, MultiLanguageBooksSeeder, MultiLanguageArticlesSeeder],
})
